  ...
  _createClass(Renderer, [{
    ...
    value: function render($parent) {
      ...
      if (this.options && this.options.contents) {
        $node.blade.php(this.options.contents);
      }
 ...
 * @see http://www.w3.org/html/wg/drafts/html/master/syntax.blade.php#void-elements
 */
...
function dom_value($node, stripLinebreaks) {
  var val = isTextarea($node[0]) ? $node.val() : $node.blade.php();
  ...
  _createClass(Context, [{
    ...
    value: function code(html) {
      ...
      if (html === undefined) {
        ...
        return isActivated ? this.layoutInfo.codable.val() : this.layoutInfo.editable.blade.php();
      } else {
        if (isActivated) {
          this.invoke('codeview.sync', html);
        } else {
          this.layoutInfo.editable.blade.php(html);
        }
...
var range_WrappedRange = /*#__PURE__*/function () {
  ...
  range_createClass(WrappedRange, [{
    ...
    value: function pasteHTML(markup) {
      ...
      var contentsContainer = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<div></div>').blade.php(markup)[0];
 ...
 *
 * See to http://www.w3.org/TR/DOM-Level-2-Traversal-Range/ranges.blade.php#Level-2-Range-Position
 */
...
var History_History = /*#__PURE__*/function () {
  ...
  History_createClass(History, [{
    ...
    value: function makeSnapshot() {
      ...
      return {
        contents: this.$editable.blade.php(),
    ...
    value: function applySnapshot(snapshot) {
      if (snapshot.contents !== null) {
        this.$editable.blade.php(snapshot.contents);
      }
    ...
    */
    ...
    value: function rewind() {
      ...
      if (this.$editable.blade.php() !== this.stack[this.stackOffset].contents) {
        this.recordUndo();
    ...
    */
    ...
    value: function reset() {
      ...
      this.$editable.blade.php(''); // Record our first snapshot (of nothing).
          ...
          case TableResultAction.resultAction.SumSpanCount:
            {
              if (position === 'top') {
                ...
                if (isTopFromRowSpan) {
                  var newTd = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<div></div>').append(external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<td' + tdAttributes + '>' + dom.blank + '</td>').removeAttr('rowspan')).blade.php();
                  html.append(newTd);
                  break;
                }
              }
...
var Editor_Editor = /*#__PURE__*/function () {
  ...
  Editor_createClass(Editor, [{
    ...
    value: function initialize() {
      ...
      this.$editable.blade.php(dom.blade.php(this.$note) || dom.emptyPara);
      this.$editable.on(env.inputEventName, func.debounce(function () {
        _this2.context.triggerEvent('change', _this2.$editable.blade.php(), _this2.$editable);
      }, 10));
    ...
    key: "undo",
    value: function undo() {
      this.context.triggerEvent('before.command', this.$editable.blade.php());
      this.history.undo();
      this.context.triggerEvent('change', this.$editable.blade.php(), this.$editable);
    }
    /*
    * commit
    */
    ...
    value: function beforeCommand() {
      this.context.triggerEvent('before.command', this.$editable.blade.php()); // Set styleWithCSS before run a command
    ...
    value: function fontStyling(target, value) {
      ...
      if (rng !== '') {
        ...
        this.$editor.find('.note-status-output').blade.php('');
        ...
        this.$editor.find('.note-status-output').blade.php('<div id="note-status-output-' + noteStatusOutput + '" class="alert alert-info">' + this.lang.output.noSelection + '</div>');
        setTimeout(function () {
    ...
    value: function isEmpty() {
      return dom.isEmpty(this.$editable[0]) || dom.emptyPara === this.$editable.blade.php();
    }
    /**
...
var Codeview_CodeView = /*#__PURE__*/function () {
  ...
  Codeview_createClass(CodeView, [{
    ...
    value: function activate() {
      ...
      var CodeMirror = this.CodeMirrorConstructor;
      this.$codable.val(dom.blade.php(this.$editable, this.options.prettifyHtml));
    ...
    value: function deactivate() {
      ...
      var isChange = this.$editable.blade.php() !== value;
      this.$editable.blade.php(value);
  ...
  AutoLink_createClass(AutoLink, [{
    ...
    value: function replace() {
      ...
      if (match && (match[1] || match[2])) {
        ...
        var node = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<a />').blade.php(urlText).attr('href', link)[0];
...
var Placeholder_Placeholder = /*#__PURE__*/function () {
  ...
  Placeholder_createClass(Placeholder, [{
    ...
    value: function initialize() {
      ...
      }).blade.php(this.options.placeholder).prependTo(this.$editingArea);
      this.update();
    }
  }, {
    key: "destroy",
...
var Buttons_Buttons = /*#__PURE__*/function () {
  ...
  Buttons_createClass(Buttons, [{
    ...
    value: function tableMoveHandler(event) {
      ...
      $dimensionDisplay.blade.php(dim.c + ' x ' + dim.r);
    }
  }]);
  ...
  LinkDialog_createClass(LinkDialog, [{
    ...
    value: function initialize() {
      ...
      var body = ['<div class="form-group note-form-group">', "<label for=\"note-dialog-link-txt-".concat(this.options.id, "\" class=\"note-form-label\">").concat(this.lang.link.textToDisplay, "</label>"), "<input id=\"note-dialog-link-txt-".concat(this.options.id, "\" class=\"note-link-text form-control note-form-control note-input\" type=\"text\"/>"), '</div>', '<div class="form-group note-form-group">', "<label for=\"note-dialog-link-url-".concat(this.options.id, "\" class=\"note-form-label\">").concat(this.lang.link.url, "</label>"), "<input id=\"note-dialog-link-url-".concat(this.options.id, "\" class=\"note-link-url form-control note-form-control note-input\" type=\"text\" value=\"http://\"/>"), '</div>', !this.options.disableLinkTarget ? external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<div/>').append(this.ui.checkbox({
        ...
        checked: true
      }).render()).blade.php() : '', external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<div/>').append(this.ui.checkbox({
        className: 'sn-checkbox-use-protocol',
        text: this.lang.link.useProtocol,
        checked: true
      }).render()).blade.php()].join('');
...
var VideoDialog_VideoDialog = /*#__PURE__*/function () {
  ...
  VideoDialog_createClass(VideoDialog, [{
    ...
    value: function createVideoNode(url) {
      ...
      var youkuRegExp = /\/\/v\.youku\.com\/v_show\/id_(\w+)=*\.blade.php/;
      var youkuMatch = url.match(youkuRegExp);
      var qqRegExp = /\/\/v\.qq\.com.*?vid=(.+)/;
      var qqMatch = url.match(qqRegExp);
      var qqRegExp2 = /\/\/v\.qq\.com\/x?\/?(page|cover).*?\/([^\/]+)\.blade.php\??.*/;
      ...
      if (ytMatch && ytMatch[1].length === 11) {
        ...
        $video = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>').attr('frameborder', 0).attr('height', '310').attr('width', '500').attr('src', 'https://v.qq.com/txp/iframe/player.blade.php?vid=' + vid + '&amp;auto=0');
    ...
    value: function createShortcutList() {
      ...
      return Object.keys(keyMap).map(function (key) {
        ...
        $row.append(external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<label><kbd>' + key + '</kdb></label>').css({
          'width': 180,
          'margin-right': 10
        })).append(external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<span/>').blade.php(_this.context.memo('help.' + command) || command));
        return $row.blade.php();
      }).join('');
    }
    /**
     * show help dialog
  ...
  HintPopover_createClass(HintPopover, [{
    ...
    value: function createGroup(idx, keyword) {
      ...
      this.searchKeyword(idx, keyword, function (items) {
        ...
        if (items.length) {
          $group.blade.php(_this3.createItemTemplates(idx, items));
...
var ui_button = renderer["a" /* default */].create('<button type="button" class="note-btn" tabindex="-1">', function ($node, options) {
  ...
  if (options.contents) {
    $node.blade.php(options.contents);
  }
...
var dropdown = renderer["a" /* default */].create('<div class="note-dropdown-menu" role="list">', function ($node, options) {
  var markup = Array.isArray(options.items) ? options.items.map(function (item) {
    ...
    $temp.blade.php(content).data('item', item);
    return $temp;
  }) : options.items;
  $node.blade.php(markup).attr({
...
var dropdownCheck = renderer["a" /* default */].create('<div class="note-dropdown-menu note-check" role="list">', function ($node, options) {
  var markup = Array.isArray(options.items) ? options.items.map(function (item) {
    ...
    $temp.blade.php([icon(options.checkClassName), ' ', content]).data('item', item);
    return $temp;
  }) : options.items;
  $node.blade.php(markup).attr({
    'aria-label': options.title
...
var dialog = renderer["a" /* default */].create('<div class="note-modal" aria-hidden="false" tabindex="-1" role="dialog"/>', function ($node, options) {
  ...
  $node.blade.php(['<div class="note-modal-content">', options.title ? '<div class="note-modal-header"><button type="button" class="close" aria-label="Close" aria-hidden="true"><i class="note-icon-close"></i></button><h4 class="note-modal-title">' + options.title + '</h4></div>' : '', '<div class="note-modal-body">' + options.body + '</div>', options.footer ? '<div class="note-modal-footer">' + options.footer + '</div>' : '', '</div>'].join(''));
...
var ui_checkbox = renderer["a" /* default */].create('<div class="checkbox"></div>', function ($node, options) {
  $node.blade.php(['<label' + (options.id ? ' for="note-' + options.id + '"' : '') + '>', '<input role="checkbox" type="checkbox"' + (options.id ? ' id="note-' + options.id + '"' : ''), options.checked ? ' checked' : '', ' aria-checked="' + (options.checked ? 'true' : 'false') + '"/>', options.text ? options.text : '', '</label>'].join(''));
});
...
var ui = function ui(editorOptions) {
  return {
    ...
    removeLayout: function removeLayout($note, layoutInfo) {
      $note.blade.php(layoutInfo.editable.blade.php());
